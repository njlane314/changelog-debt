...
Release title: PatchProof Changelog Debt v0.1.2
...
PatchProof Changelog Debt is a local-first GitHub Action and CLI from PatchProof. It produces JSON, Markdown, GitHub Step Summary output, and optional stable PR comments. It supports warn/fail modes, explicit base/head refs, and repository-local configuration.
